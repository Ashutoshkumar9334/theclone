...
interface AutomobileTextilesSectionProps {
  products: Product[];
  onProductClick: (product: Product) => void;
  onViewAll: () => void;
}

const AutomobileTextilesSection: React.FC<AutomobileTextilesSectionProps> = ({ products, onProductClick, onViewAll }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-[#1e293b] uppercase">AUTOMOBILE TEXTILES</h2>
        <button 
          onClick={onViewAll}
...
export default AutomobileTextilesSection;
