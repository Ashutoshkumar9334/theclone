...
interface BagsTextileSectionProps {
  products: Product[];
  onProductClick: (product: Product) => void;
  onViewAll: () => void;
}

const BagsTextileSection: React.FC<BagsTextileSectionProps> = ({ products, onProductClick, onViewAll }) => {
  const scrollRef = useRef<HTMLDivElement>(null);
  const intervalRef = useRef<ReturnType<typeof setInterval> | null>(null);

  // Duplicate products 6 times
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-[#1e293b] uppercase">BAGS TEXTILE</h2>
        <button 
          onClick={onViewAll}
            ...
            >
              ...
              <div className="relative aspect-square rounded-lg overflow-hidden bg-gray-50 border border-gray-100 shadow-sm mb-3">
                ...
                {product.brand === 'Custom Design' && (
                     <div className="absolute inset-0 bg-black/90 flex flex-col items-center justify-center p-2 text-center z-10 pointer-events-none">
                ...
                {/* Hover Eye Overlay (z-30 to be on top of custom overlays) */}
...
export default BagsTextileSection;
