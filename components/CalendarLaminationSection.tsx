...
interface CalendarLaminationSectionProps {
  products: Product[];
  onProductClick: (product: Product) => void;
  onViewAll: () => void;
}

const CalendarLaminationSection: React.FC<CalendarLaminationSectionProps> = ({ products, onProductClick, onViewAll }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-[#1e293b] uppercase">CALENDAR & LAMINATION</h2>
        <button 
          onClick={onViewAll}
...
export default CalendarLaminationSection;
