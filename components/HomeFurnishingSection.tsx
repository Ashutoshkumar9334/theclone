...
interface HomeFurnishingSectionProps {
  products: Product[];
  onProductClick: (product: Product) => void;
  onViewAll: () => void;
}

const HomeFurnishingSection: React.FC<HomeFurnishingSectionProps> = ({ products, onProductClick, onViewAll }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-[#1e293b] uppercase">HOME FURNISHING TEXTILE</h2>
        <button 
          onClick={onViewAll}
