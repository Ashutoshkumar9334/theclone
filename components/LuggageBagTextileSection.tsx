...
interface LuggageBagTextileSectionProps {
  products: Product[];
  onProductClick: (product: Product) => void;
  onViewAll: () => void;
}

const LuggageBagTextileSection: React.FC<LuggageBagTextileSectionProps> = ({ products, onProductClick, onViewAll }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-xl font-bold text-[#1e293b] uppercase">LUGGAGE & BAG TEXTILE</h2>
        <button 
          onClick={onViewAll}
...
export default LuggageBagTextileSection;
